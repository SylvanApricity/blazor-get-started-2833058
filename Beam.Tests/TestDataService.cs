...
namespace Beam.Tests
{
    ...
    {
        public IReadOnlyList<Frequency> Frequencies { get; private set; } = new List<Frequency>() { new Frequency() { Id = 1, Name = "One" } };
        ...
        public Task AddFrequency(string Name)
        {
            ...
            list.Add(new Frequency() { Id = Frequencies.Max(f => f.Id), Name = Name });
            Frequencies = list;
